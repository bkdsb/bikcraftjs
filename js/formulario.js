...
function formularioEnviado(resposta) {
  if (resposta.ok) {
    ...
    formulario.innerHTML = "<p class='font-2-l' style='background: #f7f7f7; grid-column: 1/-1; padding: 1rem; border-radius: 4px';><span style='color: #E00000'>Erro no envio</span>, você pode enviar diretamente para o nosso email em: contato@bikcraftjs.hypegrowth.com.br</p>";
  }
}
function enviarFormulario(event) {
  event.preventDefault();
